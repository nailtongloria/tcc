 ...
 */
@Entity
public class Sindec2014 implements Serializable {
    ...
    public String toString() {
        return "Sindec2014{" + "id=" + id + ", regiao=" + regiao + ", uf=" + uf + ", cep=" + cep + ", nome_fantasia=" + nome_fantasia + ", respondidas=" + respondidas + '}';
    }
