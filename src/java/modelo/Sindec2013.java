 ...
 */
@Entity
public class Sindec2013 implements Serializable {
    ...
    public String toString() {
        return "Sindec2013{" + "id=" + id + ", regiao=" + regiao + ", uf=" + uf + ", cep=" + cep + ", nome_fantasia=" + nome_fantasia + ", respondidas=" + respondidas + '}';
    }
