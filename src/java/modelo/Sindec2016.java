 ...
 */
@Entity
public class Sindec2016 implements Serializable {
    ...
    public String toString() {
        return "Sindec2016{" + "id=" + id + ", regiao=" + regiao + ", uf=" + uf + ", cep=" + cep + ", nome_fantasia=" + nome_fantasia + ", respondidas=" + respondidas + '}';
    }
