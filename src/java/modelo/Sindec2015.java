 ...
 */
@Entity
public class Sindec2015 implements Serializable {
    ...
    public String toString() {
        return "Sindec2015{" + "id=" + id + ", regiao=" + regiao + ", uf=" + uf + ", cep=" + cep + ", nome_fantasia=" + nome_fantasia + ", respondidas=" + respondidas + '}';
    }
