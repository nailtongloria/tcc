 ...
 */
@Entity
public class Sindec2011 implements Serializable {
    ...
    public String toString() {
        return "Sindec2011{" + "id=" + id + ", regiao=" + regiao + ", uf=" + uf + ", cep=" + cep + ", nome_fantasia=" + nome_fantasia + ", respondidas=" + respondidas + '}';
    }
