...
public class Sindec2010 implements Serializable {
    ...
    public String toString() {
        return "Sindec2010{" + "id=" + id + ", regiao=" + regiao + ", uf=" + uf + ", cep=" + cep + ", nome_fantasia=" + nome_fantasia + ", Respondidas=" + respondidas + '}';
    }
